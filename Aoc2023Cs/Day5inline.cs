...
public class Day5inline
{
    ...
    {
        public struct Entry(ulong a, ulong b, ulong c)
        {
            public ulong a;
            public ulong b;
            public ulong c;
    ...
    public static RangeMaps CreateNonTest()
    {
        RangeMaps result = new(new ulong[] {
            ...
            104364808, 4123691336, 167638723, 2284615844, 178205532, 3164519436, 564398605, 90744016, 147784453,
            577905361, 122056749
            }) {        
            new() {
